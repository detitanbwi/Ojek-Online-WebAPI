...
<body class="font-sans antialiased min-h-screen flex items-center justify-center bg-slate-950 text-slate-100 relative overflow-hidden select-none">
    ...
    <div class="w-full max-w-md p-6 sm:p-8 relative z-10">
        ...
        <div class="bg-slate-900/50 backdrop-blur-xl border border-slate-800/80 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
            ...
            <!-- Demo Mode hint -->
            <div class="mb-6 p-4 rounded-2xl bg-amber-500/10 border border-amber-500/20 text-amber-400 text-xs">
                <div class="flex items-center space-x-2 font-bold mb-1.5 uppercase tracking-widest text-[10px]">
                    <svg class="w-4 h-4 text-amber-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3Z" />
                    </svg>
                    <span>Akun Demo Pengembangan</span>
                </div>
                <div class="space-y-1 text-slate-400">
                    <p><span class="font-semibold text-slate-300">Email:</span> <code class="text-amber-300 select-all font-mono">admin@wirojek.com</code></p>
                    <p><span class="font-semibold text-slate-300">Password:</span> <code class="text-amber-300 select-all font-mono">password123</code></p>
                </div>
            </div>
